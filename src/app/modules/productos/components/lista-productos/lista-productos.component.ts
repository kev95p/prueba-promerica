...
export class ListaProductosComponent extends BaseCrudComponent implements OnInit {
  ...
  constructor(protected componentFactoryResolver: ComponentFactoryResolver,private productosService:ProductosService) {
